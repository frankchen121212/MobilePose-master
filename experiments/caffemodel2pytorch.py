...
if __name__ == '__main__':
	...
	parser.add_argument('--input',metavar = 'model.caffemodel', dest = 'model_caffemodel', help = 'Path to model.caffemodel')
	parser.add_argument('--output', dest = 'output_path', help = 'Path to converted model, supported file extensions are: h5, npy, npz, json, pt')
